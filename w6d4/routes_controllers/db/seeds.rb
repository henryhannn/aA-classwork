...
#   Character.create(name: 'Luke', movie: movies.first)
    ...
    user2 = User.create!(username: 'bob1')
    ...
    comment1 = Comment.create!(body: 'superduper!', user_id: user1.id, artwork_id: artwork1.id)
    comment2 = Comment.create!(body: 'what a great ART!', user_id: user2.id, artwork_id: artwork2.id)
